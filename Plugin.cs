...
namespace KeepUnlocks
{
    ...
    {
        const string PLUGIN_GUID = "butterystancakes.lethalcompany.keepunlocks", PLUGIN_NAME = "Keep Unlocks", PLUGIN_VERSION = "1.0.2";
        ...
        void Awake()
        {
            ...
            configAutoStore = Config.Bind("Miscellaneous", "AutoStore", true, "Automatically place furniture and/or upgrades into storage. Might be buggy");
